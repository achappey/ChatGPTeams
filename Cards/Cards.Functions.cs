...
namespace achappey.ChatGPTeams.Cards
{
    public static partial class ChatCards
    {
        ...
        public static Attachment CreateFunctionExecutedCarddasdsa(string name, string incomingTextValue, string arguments)
        {
            // parse the JSON string to a dictionary
            var argumentDict = JsonConvert.DeserializeObject<Dictionary<string, string>>(arguments);
        ...
        public static Attachment CreateFunctionExecutedCard2(string name, string incomingTextValue)
        {
            var card = new AdaptiveCard(new AdaptiveSchemaVersion(1, 0))
            {
                Body = {
